...
![Relation between IA-ML-DL](../images/a1_DL-enven.png "Relation between IA-ML-DL"){#fig-DLenven fig-alt="IA engloba a ML y ML engloba a DL"}
...
if(knitr::pandoc_to("html") ||
  ...
  knitr::asis_output("![How the size of the filter affects the output vector](../images/a1_HJ-ksen.gif){#fig-HJksen}")
}else if(knitr::pandoc_to("latex")){
  knitr::asis_output('[![How the size of the filter affects the output vector](../images/a1_HJ-ksen.png){#fig-HJksen}](https://gist.github.com/davidrsch/3bfcece719d1b3ba019ed066a4cb1d4d)')
}
```
...
if(knitr::pandoc_to("html") ||
   knitr::pandoc_to("docx")){
  knitr::asis_output("![How stride affects the output vector](../images/a1_HJ-strideen.gif){#fig-HJstrideen}")
}else if(knitr::pandoc_to("latex")){
  knitr::asis_output('[![How stride affects the output vector](../images/a1_HJ-strideen.png){#fig-HJstrideen}](https://gist.github.com/davidrsch/27872825c8e61b9076594051142f01a0)')
}
```
...
if(knitr::pandoc_to("html") ||
   knitr::pandoc_to("docx")){
  knitr::asis_output("![How dilation affects the output vector](../images/a1_HJ-dilationen.gif){#fig-HJdilationen}")
}else if(knitr::pandoc_to("latex")){
  knitr::asis_output('[![How dilation affects the output vector](../images/a1_HJ-dilationen.png){#fig-HJdilationen}](https://gist.github.com/davidrsch/e2bc5520db18bfe1d1159f2a2d830f48)')
}
```
...
if(knitr::pandoc_to("html") ||
   knitr::pandoc_to("docx")){
  knitr::asis_output("![How padding affects the output vector](../images/a1_HJ-paddingen.gif){#fig-HJpaddingen}")
}else if(knitr::pandoc_to("latex")){
  knitr::asis_output('[![How padding affects the output vector](../images/a1_HJ-paddingen.png){#fig-HJpaddinen}](https://gist.github.com/davidrsch/fa011845f1fef68973e1945879719f48)')
}
```
...
if(knitr::pandoc_to("html") ||
   knitr::pandoc_to("docx")){
  knitr::asis_output("![Input and output vector display](../images/a2_muestrasen.gif){#fig-muestrasen}")
}else if(knitr::pandoc_to("latex")){
  knitr::asis_output('[![Input and output vector display](../images/a2_muestrasen.png){#fig-muestrasen}](https://gist.github.com/davidrsch/bddcafb7223b0c0366ec78d568646d51)')
}
```
...
![Different structures depending on the different sizes of input vectors](../images/a2_estructurasen.png){#fig-estructurasen}
...
![ReLU and Leaky ReLU domain](../images/a2_dominiosen.png){#fig-dominiosen}

::: figure-caption
Own elaboration: Elaborated from the images that can be seen in @Rallabandi23.
:::

![Flowchart of the Walk Forward Validation methodology](../images/a2_wfven.png){#fig-wfven}
