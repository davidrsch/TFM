...
A more detailed explanation of the code used during the procedure described in this subsection can be found in @sec-A-modelos.

As previously explained, the main elements of the artificial neural network models used are a CNN layer and an LSTM layer. In addition to this, an input layer and an output layer were used, which are in charge of supplying the models with the information of the vectors previously constituted. A more detailed explanation regarding the code used to carry out the procedure described in this sub-heading can be found in @sec-A-modelos.

Since three different sizes of observations were defined to take into account to make a prediction, it was necessary to build three different model structures that would adapt to the dimensions of the different input vectors, the different structures can be observed in the @fig-estructuras.
...
A more detailed explanation of the code used during the procedure described in this subsection can be found in @sec-A-entrenamiento.
