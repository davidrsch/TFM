...
*Note:* You can find untrained models in the `data` folder of the repository where this work is located. The models were saved using the `hdf5` extension and under the names `model1e`, `model2e` and `model3e`.
