...
El código del procedimiento expuesto en el presente trabajo, @sec-code, fue desarrollado usando la versión 4.3.1 de R y la versión 2023.06.1-524 del software RStudio. Los paquetes necesarios para la ejecución del código son los siguientes:
